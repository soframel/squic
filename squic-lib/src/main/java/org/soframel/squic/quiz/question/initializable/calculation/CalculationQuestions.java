...
public class CalculationQuestions implements InitializableQuestions {
    ...
    public List<MultipleChoiceResponse> getResponses() throws Exception {
        //no "common" responses for quiz, only responses specific to question (calculated based on min/max/etc)
        return null;
    }
     ...
     * @return
     */
    private IntWithDivisors getNextDivisionOperand(IntWithDivisors previousValue, int minValue, int maxValue, boolean lastOperand){
