	...
	<body>
		...
		<div id="show-color" class="content scaffold-show" role="main">
			...
			<ol class="property-list color">
				...
				<g:if test="${colorInstance?.colorCode}">
				<li class="fieldcontain">
					<span id="colorCode-label" class="property-label"><g:message code="color.colorCode.label" default="Color Code" /></span>
					
						<span class="property-value" aria-labelledby="colorCode-label"><g:fieldValue bean="${colorInstance}" field="colorCode"/></span>
