			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="colorCode" title="${message(code: 'color.colorCode.label', default: 'Color Code')}" />
				...
				<g:each in="${colorInstanceList}" status="i" var="colorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${colorInstance.id}">${fieldValue(bean: colorInstance, field: "colorCode")}</g:link></td>
